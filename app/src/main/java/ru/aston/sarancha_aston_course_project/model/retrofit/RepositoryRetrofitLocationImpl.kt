...
class RepositoryRetrofitLocationImpl {

    val episodeResult = MutableLiveData<LocationDto>()
    ...
    fun getLocationData(pageNumber: Int): Single<LocationDto> {
        return retrofitImpl
            .build()
            .create(RickAndMortyAPI::class.java)
            .getLocationList(pageNumber)
